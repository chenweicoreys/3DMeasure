...
public class XsControl : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal XsControl(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(XsControl obj) {
  ...
  public static SWIGTYPE_p_XsControl construct() {
    IntPtr cPtr = xsensdeviceapiPINVOKE.XsControl_construct();
    SWIGTYPE_p_XsControl ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_XsControl(cPtr, false);
    return ret;
  }
  ...
  public static bool setSerialKey(XsString key) {
    bool ret = xsensdeviceapiPINVOKE.XsControl_setSerialKey(XsString.getCPtr(key));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void flushInputBuffers(bool complete) {
    xsensdeviceapiPINVOKE.XsControl_flushInputBuffers(swigCPtr, complete);
  }
  ...
  public SWIGTYPE_p_XsDevice getDeviceFromLocationId(ushort locationId) {
    IntPtr cPtr = xsensdeviceapiPINVOKE.XsControl_getDeviceFromLocationId(swigCPtr, locationId);
  ...
  public void setQueueMode(XsQueueMode mode) {
    xsensdeviceapiPINVOKE.XsControl_setQueueMode(swigCPtr, (int)mode);
  }

  public XsQueueMode queueMode() {
    XsQueueMode ret = (XsQueueMode)xsensdeviceapiPINVOKE.XsControl_queueMode(swigCPtr);
    return ret;
  }
  ...
  public void setOptionEnabled(XsOption option, bool enabled) {
    xsensdeviceapiPINVOKE.XsControl_setOptionEnabled(swigCPtr, (int)option, enabled);
  }

  public bool isOptionEnabled(XsOption option) {
    bool ret = xsensdeviceapiPINVOKE.XsControl_isOptionEnabled(swigCPtr, (int)option);
    return ret;
  }
  ...
  public SWIGTYPE_p_XsDevice device(XsDeviceId deviceId) {
    IntPtr cPtr = xsensdeviceapiPINVOKE.XsControl_device(swigCPtr, XsDeviceId.getCPtr(deviceId));
    SWIGTYPE_p_XsDevice ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_XsDevice(cPtr, false);
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_XsDevice broadcast() {
    IntPtr cPtr = xsensdeviceapiPINVOKE.XsControl_broadcast(swigCPtr);
    SWIGTYPE_p_XsDevice ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_XsDevice(cPtr, false);
    return ret;
  }
