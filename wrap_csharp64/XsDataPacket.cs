...
public class XsDataPacket : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal XsDataPacket(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(XsDataPacket obj) {
  ...
  public int itemOffsetExact(XsDataIdentifier id) {
    int ret = xsensdeviceapiPINVOKE.XsDataPacket_itemOffsetExact(swigCPtr, (int)id);
    return ret;
  }

  public int itemOffsetLoose(XsDataIdentifier id) {
    int ret = xsensdeviceapiPINVOKE.XsDataPacket_itemOffsetLoose(swigCPtr, (int)id);
    return ret;
  }

  public XsDataIdentifier lastFoundId() {
    XsDataIdentifier ret = (XsDataIdentifier)xsensdeviceapiPINVOKE.XsDataPacket_lastFoundId(swigCPtr);
    return ret;
  }

  public int lastFoundOffset() {
    int ret = xsensdeviceapiPINVOKE.XsDataPacket_lastFoundOffset(swigCPtr);
    return ret;
  }
  ...
  public XsMessage message() {
    XsMessage ret = new XsMessage(xsensdeviceapiPINVOKE.XsDataPacket_message__SWIG_0(swigCPtr), false);
    return ret;
  }
  ...
  public XsMessage originalMessage() {
    XsMessage ret = new XsMessage(xsensdeviceapiPINVOKE.XsDataPacket_originalMessage(swigCPtr), true);
    return ret;
  }
  ...
  public static byte getFPValueSize(XsDataIdentifier id) {
    byte ret = xsensdeviceapiPINVOKE.XsDataPacket_getFPValueSize((int)id);
    return ret;
  }
  ...
  public bool containsStatusByte() {
    bool ret = xsensdeviceapiPINVOKE.XsDataPacket_containsStatusByte(swigCPtr);
    return ret;
  }
  ...
  public XsDataPacket append(XsDataPacket other) {
    XsDataPacket ret = new XsDataPacket(xsensdeviceapiPINVOKE.XsDataPacket_append(swigCPtr, XsDataPacket.getCPtr(other)), false);
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public int containsTriggerIndication(XsDataIdentifier triggerId) {
    int ret = xsensdeviceapiPINVOKE.XsDataPacket_containsTriggerIndication(swigCPtr, (int)triggerId);
    return ret;
  }
